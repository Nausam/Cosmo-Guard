    ...
    <section id="pricing" className="w-full">
      ...
      <div className="flex max-w-6xl mx-auto m-5 py-2 px-10 items-center mt-20 p-5">
        <div className="flex flex-wrap items-center justify-center gap-10 mx-auto">
          <div className="border-2 shadow-xl  border-gray-400 hover:border-red-500 dark:hover:border-red-500 dark:border-gray-800 rounded-md p-10">
          ...
          <div className="border-2 shadow-xl  border-orange-400 dark:border-orange-500 hover:border-red-500 dark:hover:border-red-500  rounded-md p-10">
            <div className="flex flex-col items-center justify-center w-full h-full">
              <h2 className="mt-8 font-bold text-3xl dark:text-gray-300 tracking-wide">
                1 Month
              </h2>
